<html>
  ...
  <div id="wrapper">
    ...
    <div class="modal fade" id="relatorio_data_analise" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
      ...
      <div class="modal fade" id="relatorio_data_cobrancas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Relatorio por Data dos processos em cobranças</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
              </div>
      ...
      <div class="modal fade" id="ativar_desativar_usuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="user" name="form-ativar-destivar-usuario"></form>
                </div>
                <div class="modal-footer">
                  <button class="btn btn-primary ativar-desativar-usuario">Ativar/Desativar</button>
                </div>
            </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="alterar_senha_usuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="user" name="form-alterar-senha-usuario"></form>
            </div>
            <div class="modal-footer">
